                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 profile_details margin_bottom_30">
                                       ...
                                       <div class="contact_blog">
                                          ...
                                          <div class="contact_inner">
                                             <div class="left">
                                                <h3><?php echo $data[$i]['full_name']; ?></h3>
                                                <p><strong>specialty: </strong><?php echo $data[$i]['specialty']; ?></p>
                                             ...
                                             <div class="bottom_list">
                                                ...
                                                <div class="right_button">
                                                   <form action="../api/admin/deletedoctor.php" method="POST">
                                                      <input name="deldoc" value="<?php echo $data[$i]['id'] ?>" type="text" placeholder=<?php echo $data[$i]['id'] ?> style="display:none">
