...
$reservations = $reservation->getReservationsByPatientId($id);
            ...
            <tbody>
                <?php foreach ($reservations as $reservation) { ?>
                    <tr>
                        ...
                        <td><?php echo $reservation['reservation_start_time']; ?></td>
                        <td><?php echo $reservation['reservation_end_time']; ?></td>
                        <td><?php echo $reservation['doctor_name']; ?></td>
                        <td><?php echo $reservation['payment_amount']; ?></td>
                        <td><?php echo $reservation['payment_method']; ?></td>
                        <td><?php echo $reservation['payment_date']; ?></td>
                        <td>
                        ...
                        <td>
                            <form action="api/reservation/deleteReservation.php" method="POST">
