...
$role;
$logged_in;
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] == false || $_SESSION['role'] != "doctor" || !isset($_SESSION['doctor'])) {
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT id, name, address, phone_number, doctor_id FROM clinic where doctor_id = " . $id . " ORDER BY id DESC";
    ...
    <div class="container d-flex justify-content-center align-items-center flex-column" style="margin: 0 auto; width:700px;">
        <h1>Add Clinic</h1>
        <form method="POST" action="../api/clinic/add_clinic.php" style="display: flex; flex-direction: column; width: 100%; max-width: 500px; margin: 0 auto;">
